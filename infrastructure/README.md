...
This directory contains Terraform to register the Court Houses API with the
...
|---|---|
| APIM Product | `cp-refdata-courthearing` — subscription tier grouping APIs |
| APIM API | `courthouses` — registered from the OpenAPI spec at `src/main/resources/openapi/openapi-spec.yml` |
